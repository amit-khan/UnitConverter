...
public class AngleActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private final String[] length = {"Degree (deg)","Radian (rad)","Grad (grad)"};
    ...
    double[] arr;
    final double[] L0 = {.01745329,1.1111111};
    final double[] L1 = {57.295779,63.661977};
    final double[] L2 = {.9,.0157079};
