...
public class EnergyActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private final String[] length = {"Joule (j)","Kilojoule (kj)","Kilowatt-hour (kWh)", "Calorie (cal)",
            "Kilocalorie (kcal)","Electron Volt (eV)"};
    ...
    double[] arr;
    final double[] L0 = {.001,2.777e-7,.239,.000239,6.242e18};
    final double[] L1 = {1000,.000277,239.006,.239,6.242e21};
    final double[] L2 = {3.6e6,3600,860421,860.421,2.247e25};
    final double[] L3 = {4.184,.004184,1.162e-6,.001,2.611e19};
    final double[] L4 = {4184,4.184,.00116,1000,2.611e22};
    final double[] L5 = {1.6022e-19,1.6022e-22,4.4505e-26,3.8293e-20,3.8293e-23};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_length);
        setTitle("Energy");  //chng
